...
getting match data from route
2. How would you explain form validation to someone who has never programmed before?
validation makes sure that you put everything in correct format in your Form. like you should'nt add username as email and etc.
